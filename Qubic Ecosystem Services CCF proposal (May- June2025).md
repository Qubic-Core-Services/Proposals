...
## 🌐 Language Separator | 语言分隔线 🌐

**English (above) | 英文 (上方)**  
**Simplified Chinese (below) | 简体中文 (下方)**
...
在过去8个月中，生态系统团队面临了内部和外部的多重挑战，这些挑战威胁到我们对社区的承诺。我们旨在提高所有活动和潜在依赖关系的透明度，以可持续的速度增长，确保Qubic未来的大规模采用和成功。

为此，生态系统团队决定更新我们提交提案的方式：

- **QES（Qubic生态系统服务）** 将定期提交独立的提案，请求基础成本的资金，例如薪资、基础设施、审计、外包服务和差旅费用。所有这些提案都将包含成本明细、时间表和交付物/关键绩效指标（KPIs）。这些提案旨在覆盖生态系统团队执行任务的常规成本。本提案是此类提案的第一个。
- **QES将提交临时提案**，针对特定活动、工具或需要计算者（Computors）投票的重大变化（详见第3节 - 交付物）。所有这些提案将包括理由、成本明细、交付物、KPIs和投资回报率（ROI，当适用时）。
- **QES认为这是实现财务透明的最佳方法。** 然而，为了对QES承担的所有职责保持问责，并承认QES对社区的责任，当前或未来提交的所有其他提案，若可能修改资助与孵化治理模式或QES代表的任何举措，均须经QES批准。否则，QES将不对由此产生的任何表现不佳负责。
- **QES的目标是尽可能透明和高效**，但也需要一定的灵活性和独立性来履行所有承诺。如果我们想实现伟大的目标，每两个月就调整方向是不可能的。大项目需要时间来执行。

## 2. 已交付的价值（过去8个月）

| 交付内容                | 执行的关键证据                                                                 | 对社区的直接价值                                                                     |
|-------------------------|--------------------------------------------------------------------------------|--------------------------------------------------------------------------------------|
| **全球活动参与**        | - 哥斯达黎加峰会：350+机构与会者<br>- 马德里黑客马拉松：120名开发者，9个现场演示 | 开启大学访问（拉丁大学、IEB），政府合作（CINDE、MinTIC、马德里社区）及企业渠道（Accenture/Telefónica） |
| **开发者基础设施**      | - 公共测试网访问<br>- 浏览器CLI + 智能合约编辑器发布<br>- QA里程碑模板<br>- 托管集成（Onyze） | 使25+团队无需核心团队协助即可开发 – 3个项目现已为主网准备就绪                      |
| **战略性资金渠道**      | - 执行135,000美元资助<br>- 部署142,000美元孵化资金<br>- 50,000+美元赞助承诺 | 创建清晰的资金路径：9个项目完成 → 3个进入孵化 → 2个主网发布                     |
| **机构信誉**            | - 白皮书发布<br>- 联合国教科文组织道德AI合作<br>- ResearchGate发布<br>- 拉丁大学学术合作 | 使Qubic的技术和目标为所有人理解。直接影响哥斯达黎加的国家AI战略和欧洲央行数字欧元的技术基准讨论 |
| **企业准备就绪**        | - Accenture用例研讨会<br>- 马德里社区及Alastria联盟合作（最大的区块链联盟）<br>- 智能合约模板 | 识别12个合格的企业场景，等待Aigarth成熟。3个项目由马德里社区和Alastria资助      |

## 3. 交付物和评估QES成功的KPI（2025年5月至7月）

| 交付物                     | KPI（截至2025年7月31日）                                                                                     |
|----------------------------|--------------------------------------------------------------------------------------------------------------|
| 3个主网孵化项目           | Vottun Bridge • Nostromo SC • QSwap — 发布3个交易哈希                                                |
| 资助与孵化披露            | - 创建资助与孵化的公共渠道<br>- 每两周报告所有举措（资助、孵化、合作等）的绩效和财务情况<br>- 更新社区检查进度的工具（智能合约电子表格或Trello/PowerBI仪表板） |
| QES AMA                    | 每月与生态系统团队进行AMA，报告总体进展、下一步计划和路线图                                         |
| 投票工具                   | 生态系统团队将开发一个dApp，让社区参与相关决策，例如可能解散资助委员会、生态系统可能想组织/参与的重大活动等。社区还将决定是否需要将此类提案升级至计算者投票（因为需要资金或其他原因） |
| 资助吞吐量                 | ≥ 5个资助项目达到里程碑2                                                                             |
| 新合作伙伴关系             | ≥ 1个签署                                                                                            |
| 科学论文                   | ≥ 1篇新论文提交同行评审                                                                              |
| 测试网                     | 运行公共测试网，并在IPO前为社区测试部署2个智能合约<br><br>生产就绪QFORGE，一个动态测试测试网或主网中智能合约的工具 |
...
- 总监：Alber
- 企业关系与战略：Daniel
- 在 `#QES` 频道每两周发布Discord报告，包括里程碑状态和开放问答线程。
- 为团队提供私人Discord工作区以获取QA和技术支持。
- 大型一次性举措（未来黑客马拉松、活动、整合等）将发布单独提案，由社区投票决定。
...
- 提供生态系统增长和业务领导力及执行力。
- QES的目标是从现在的项目孵化运营模式（支持所有早期项目以验证可行性/吸引力/可行性）演变为规模化风险投资运营模式，作为已验证产品市场契合项目的资金伙伴。因此，QES将逐渐成熟，承担更多长期战略任务而非当前的操作任务。
...
- 每周在 `#QES` 发布状态更新，展示：路线图、下一周重点、障碍。
- 每两周深入分析（相同数据+里程碑QA结果）。
- 每个报告下开放问答线程（24-48小时响应）。
- 为孵化/资助项目提供私人Discord工作区以共享代码并获取QA帮助，提供只读“观察者”角色，供希望观看的计算者使用。

**问题6：如果我们需要新的黑客马拉松或新举措怎么办？**\
为提供完全透明并让社区和计算者决定资金使用，QES将定期识别新举措，如黑客马拉松和公开挑战，并起草专注的提案（范围、成本、KPI）以供投票。这样，所有举措都可以独立衡量。\
基础970亿请求仅涵盖生态系统日常运营工作。

**问题7：服务器费用**

- 1个公共测试网服务器，我们将在QCT帮助下运营。
- 3个测试网服务器用于团队和部署的解决方案。
