...
| Strategic partnerships | **Academic & Education**<br>- **1. University of Latina:** Training thousands of devs in AI/blockchain.<br>- **2. UNESCO:** Collaborating on ethical AI frameworks aligned with UN sustainability goals.<br>- **3. IEB:** Collaborating with the blockchain and AI program.<br><br>**Corporate & Tech**<br>- **4. Accenture:** Implementing Qubic in Fortune 500 companies & govs.<br>- **Telefónica:** Defining solutions for use cases based on high TPS output and low latency for P2P & M2M communications.<br>- **5. Alastria (Spain's top blockchain consortium):** Funding Qubic applications to create value for over 500+ Spanish companies (e.g., Santander, Repsol).<br>- **6. Comunidad de Madrid:** Funding the best applications that position the Community of Madrid as an AI Hub.<br><br>**Governments & Public Sector**<br>- **7. Madrid Government:** Pilot projects for AI-driven smart cities.<br>- **8. CINDE:** Strategic agreement to train and onboard strategic industries from Costa Rica into AI.<br><br>**Startups & Innovators**<br>- **9. Tritemius:** Investing into Qubic’s most prominent incubation projects.<br>- **10. Onyze:** Providing custody & security solutions for institutional scale.<br>- **Vottun:** Providing simplified solutions for devs to deploy technical products & solutions on Qubic. |        |
...
| 测试网 | 马德里黑客马拉松期间使用，现对所有资助与孵化项目开放 | 简化开发流程，提高代码质量，简化开发者接入 |
